...
public class WindowsCredentialManager {
     ...
     */
    public void initialize(String encryptionKey) throws SecureStorageException {
     ...
     * @throws SecureStorageException if setting the key fails
     */
     ...
     * @param packageName Application package name
     * @throws SecureStorageException if setting the prefix fails
     *                                Sets the application prefix for credential names based on package name
     */
     ...
     */
    public void addCredential(String key, JSONObject jsonValue) throws SecureStorageException {
     ...
     * @throws SecureStorageException if the operation fails
     */
    private void addRawCredential(String credName, String value) throws SecureStorageException {
...
//        System.out.println("🚨??Credential Value: " + value);
     ...
     */
    public JSONObject getCredential(String key) throws SecureStorageException {
        ...
        if (encryptedMetadata == null) {
            throw new SecureStorageException("Credential metadata not found for key: " + key);
        }
        ...
        if (chunks == 0) {
            ...
            if (encryptedValue == null) {
                throw new SecureStorageException("Credential not found for key: " + key);
            }
            ...
            for (int i = 0; i < chunks; i++) {
                ...
                if (chunkValue == null) {
                    throw new SecureStorageException("Credential chunk " + i + " not found for key: " + key);
                }
     ...
     * @throws SecureStorageException if retrieval fails for technical reasons
     */
    private String getRawCredential(String credName) throws SecureStorageException {
        ...
        if (!success) {
            ...
            throw new SecureStorageException("Failed to read credential, error code: " + errorCode);
        }
...
//    }
     ...
     */
    private void deleteRawCredential(String credName) throws SecureStorageException {
