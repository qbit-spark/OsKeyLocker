...
public class SecureStore {
    ...
    /**
     * Implementation of the read operation builder
     */
    ...
    public interface StorageWriter {
         ...
         */
        boolean execute() throws SecureStorageException;
    }
    ...
    public interface StorageReader {
         ...
         * @throws SecureStorageException if operation fails
         */
        Map<String, Object> getAllProperties() throws SecureStorageException;
         ...
         * @throws SecureStorageException if operation fails
         */
        Object getProperty(String key) throws SecureStorageException;
         ...
         * @throws SecureStorageException if operation fails
         */
        boolean exists() throws SecureStorageException;
    }
