...
public class EncryptionUtil {
     ...
     */
    public EncryptionUtil(String encryptionKey) throws SecureStorageException {
        try {
            ...
            throw new SecureStorageException("Failed to initialize encryption", e);
        }
    }
     ...
     */
    public String encrypt(String plainText) throws SecureStorageException {
        try {
            ...
            throw new SecureStorageException("Encryption failed", e);
        }
    }
     ...
     */
    public String decrypt(String encryptedText) throws SecureStorageException {
        try {
            ...
            throw new SecureStorageException("Decryption failed", e);
        }
    }
     ...
     * @throws SecureStorageException if key generation fails
     */
    public static String generateEncryptionKey() throws SecureStorageException {
        try {
            ...
            throw new SecureStorageException("Failed to generate encryption key", e);
        }
    }
}